	...
	return (
		<>
			...
			<div className="p-10 bg-[#f5f5f5] rounded-3xl flex flex-row justify-between items-start gap-[50px] mb-[16px]">
				...
				<div>
					<form className="flex flex-col h-[100%] gap-4 justify-between min-w-[500px]">
						<div className={inputStyles.inputGroup}>
							<input
								...
								required
							/>
							<label htmlFor="first_name" className="text-[#666] hover:cursor-text">Ism</label>
						</div>
						<div className={inputStyles.inputGroup}>
							<input
								value={lastName}
								...
								required
							/>
							<label htmlFor="last_name" className="text-[#666] hover:cursor-text">Familiya</label>
						</div>
						<div className={inputStyles.inputGroup}>
							<input
								value={email}
								...
								required
							/>
							<label htmlFor="email" className="text-[#666] hover:cursor-text">E-mail manzil</label>
						</div>
					...
					>
						<div className={inputStyles.inputGroup}>
							<input
								...
								required
							/>
							<label htmlFor="password1" className="text-[#666] hover:cursor-text">Parol</label>
						</div>
						<div className={inputStyles.inputGroup}>
							<input
								value={password2}
								...
								required
							/>
							<label htmlFor="password2" className="text-[#666] hover:cursor-text">Parolni tasdiqlang</label>
						</div>
						<button
							disabled
